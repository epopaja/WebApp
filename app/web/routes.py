...
from app.web.forms import LoginForm, RegistrationForm, UpdateForm
...
from app.web.database import Database
...
def update():
    if 'user' in session:
        ...
        if form.validate_on_submit():
            ...
            Database.update_one(collection="users", query=[{'uname': user.uname}, {"$set": { "phone": form.phone.data }} ])
